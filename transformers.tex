...
%  - position encoding
%  - masking
\question{We have five colored tokens in the diagram above (gray, blue, orange, green, red). Could you read off the diagram the correspondence between the color and input, query, value, output? }
