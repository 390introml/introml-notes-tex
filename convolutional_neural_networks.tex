...
A max pooling layer operates like a filter, but has no weights. {\em
    You can think of it as a pure functional layer, like a ReLU layer in
    a fully connected network.}  It has a filter size\index{filter!filter size}, as in a filter
